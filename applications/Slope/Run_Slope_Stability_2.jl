...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_2(", myid(), ")"))
...
#init_Beam_MC_L_Het_Single=Coupling_Slope.init_Slope(ML(),true,false,false,true,true,startlevel=0,MatlabSampler,folder,folder_with_elements,false,numberoftol=10,nb_of_warm_up_samples=2,nshifts=10,nterms=210)
#estimator=init_Beam_MC_L_Het_Single
#history = run(estimator,5e-05)
