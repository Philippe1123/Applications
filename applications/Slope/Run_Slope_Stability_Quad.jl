...
folder_with_elements=string(pathToInterm,"/Mesh/Slope/Quad")
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_Quad(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope.init_Slope(ML(),true,false,false,true,true,startlevel=0,max_level=4,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=nterms,correlateOnlyDiffs=false,corr_len=0.3,smoothness=2.0,point_generator=pt)
estimator=init_Beam_MC_L_Het_Single
