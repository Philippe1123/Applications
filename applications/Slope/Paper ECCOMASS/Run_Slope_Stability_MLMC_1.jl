...
init_Beam_MC_L_Het_Single=Coupling_Slope_MLMC.init_Slope(ML(),false,false,false,true,false,startlevel=0,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nterms=400,max_level=4,corr_len=0.3,smoothness=2.0)
estimator=init_Beam_MC_L_Het_Single
