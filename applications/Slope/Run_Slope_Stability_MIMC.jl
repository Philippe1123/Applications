...
@everywhere using Coupling_Slope_MIMC
...
folder = string(pathToInterm,"/Interm11/Slope") # for report
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_MIMC(", myid(), ")"))
...
#------------------
nterms=400
pt=LatticeRule("/vsc-hard-mounts/leuven-user/330/vsc33032/.julia/dev/MultilevelEstimators/applications/SPDE/lattice-32001-1024-1048576.3600.txt",nterms)

init_Beam_MC_L_Het_Single=Coupling_Slope_MIMC.init_Slope(FT(2),true,false,false,true,true,startlevel=0,max_level=6,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=nterms,correlateOnlyDiffs=true,corr_len=0.3,point_generator=pt,smoothness=2.0,adaptive_MIMC=true)
estimator=init_Beam_MC_L_Het_Single
