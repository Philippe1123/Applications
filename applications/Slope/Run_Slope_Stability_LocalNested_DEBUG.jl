...
@everywhere using Coupling_Slope_DEBUG
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_LocalNested_DEBUG(", myid(), ")"))
