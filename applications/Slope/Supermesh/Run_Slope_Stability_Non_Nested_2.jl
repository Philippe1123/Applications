...
using Coupling_Slope_Non_Nested
using Pkg
using MATLAB
...
@everywhere using Coupling_Slope_Non_Nested
...
folder = string(pathToInterm,"/Interm8/Slope") # for report
folder_with_elements=string(pathToInterm,"/Mesh/Slope/NN")
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_Non_Nested_2(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope_Non_Nested.init_Slope(ML(),true,false,false,true,true,startlevel=0,max_level=6,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=nterms,correlateOnlyDiffs=false,corr_len=0.3,smoothness=2.0,point_generator=pt)
estimator=init_Beam_MC_L_Het_Single
