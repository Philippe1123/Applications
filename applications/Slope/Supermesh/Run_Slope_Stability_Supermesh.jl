...
using Coupling_Slope_Supermesh
using Pkg
using MATLAB
...
@everywhere using Coupling_Slope_Supermesh
...
init_Beam_MC_L_Het_Single=Coupling_Slope_Supermesh.init_Slope(ML(),true,false,false,true,true,startlevel=0,max_level=6,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=nterms,correlateOnlyDiffs=false,corr_len=0.2,smoothness=2.0,point_generator=pt)
estimator=init_Beam_MC_L_Het_Single
