...
@everywhere using Coupling_Slope_Tent_2
...
folder = string(pathToInterm,"/Interm28/Slope") # for report
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_LocalNested_18(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope_Tent_2.init_Slope(SL(),true,false,false,true,true,startlevel=0,max_level=0,MatlabSampler,folder,folder_with_elements,false,numberoftol=200,nb_of_warm_up_samples=2,nshifts=8,nterms=nterms,correlateOnlyDiffs=true,corr_len=1.5,smoothness=14.0,point_generator=pt)
estimator=init_Beam_MC_L_Het_Single
