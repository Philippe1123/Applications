...
#exp_field = GaussianRandomFields.Exponential(1.0,σ=1,p=2)
exp_field = GaussianRandomFields.Matern(0.6,4.0,σ=1.,p=2)
...
PathElement=string(string(folder_with_elements,string("/","Elements_L",Access)),".txt")
...
PathNodes=string(string(folder_with_elements,string("/","Nodes_L",Access)),".txt")

PathElementCenters=string(string(folder_with_elements,string("/","ElementsCenter_L",Access)),".txt")
...
println("h-ref")
    ...
    PathNodesElements=string(string(folder_with_elements,string("/","Nodes_L",Access)),".txt")
...
#  PathNodes=string(string(folder_with_elements,string("/","GaussPoints_L",Access)),".txt")
  PathNodes=string(string(folder_with_elements,string("/","GaussPoints_L_6_M6_S6")),".txt")
