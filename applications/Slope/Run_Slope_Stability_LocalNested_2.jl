...
folder = string(pathToInterm,"/Interm6/Slope") # for report
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_LocalNested_2(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope.init_Slope(ML(),true,false,false,true,true,startlevel=0,max_level=6,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=nterms,correlateOnlyDiffs=true,corr_len=0.3,smoothness=2.0,point_generator=pt)
estimator=init_Beam_MC_L_Het_Single
