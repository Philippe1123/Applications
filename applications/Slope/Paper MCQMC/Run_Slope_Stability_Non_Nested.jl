...
folder = string(pathToInterm,"/Interm2/Slope") # for report
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_Non_Nested(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope_Non_Nested.init_Slope(ML(),false,false,false,true,true,startlevel=0,max_level=6,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=40,nshifts=10,nterms=nterms,correlateOnlyDiffs=false,corr_len=1.5,smoothness=2.0,point_generator=pt)
estimator=init_Beam_MC_L_Het_Single
