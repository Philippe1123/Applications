...
@everywhere using Coupling_Slope_MLMC
...
folder = string(pathToInterm,"/Interm5/Slope") # for report
folder_with_elements=string(pathToInterm,"/Mesh/Slope/MLMC_2")
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_MLMC_2(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope_MLMC.init_Slope(ML(),true,false,false,true,false,startlevel=0,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nterms=400,max_level=4,corr_len=0.2,smoothness=2.0,point_generator=pt,nb_of_warm_up_samples=2,nshifts=10)
estimator=init_Beam_MC_L_Het_Single
...
#init_Beam_MC_L_Het_Single=Coupling_Slope.init_Slope(ML(),true,false,false,true,true,startlevel=0,max_level=8,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=210)
#estimator=init_Beam_MC_L_Het_Single
#history = run(estimator,5e-07)
