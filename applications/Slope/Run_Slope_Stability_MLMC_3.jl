...
@everywhere using Coupling_Slope_MLMC_3
...
folder = string(pathToInterm,"/Interm7/Slope") # for report
folder_with_elements=string(pathToInterm,"/Mesh/Slope/MLMC_3")
...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_MLMC_3(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope_MLMC_3.init_Slope(ML(),false,false,false,true,false,startlevel=0,MatlabSampler,folder,folder_with_elements,false,numberoftol=1,nterms=400,max_level=4,corr_len=1.5,smoothness=2.0)
estimator=init_Beam_MC_L_Het_Single
history = run(estimator,1.310e-03)
