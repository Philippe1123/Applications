...
@everywhere MatlabSampler() = eval_string(string("Slope_Slover_JULIA_MATLAB_Dev(", myid(), ")"))
...
init_Beam_MC_L_Het_Single=Coupling_Slope.init_Slope(ML(),true,false,false,true,true,startlevel=0,max_level=3,MatlabSampler,folder,folder_with_elements,false,numberoftol=34,nb_of_warm_up_samples=2,nshifts=10,nterms=10,correlateOnlyDiffs=true)
estimator=init_Beam_MC_L_Het_Single
