...
NumberOfGaussPoints=[16  73 126]; %Paper
...
str_interm=str_folder+"Interm8/Slope/";
...
if(length(level)==1)
    ...
    elseif(HigherOrder==1) %Pure p refinement
        Order=level_num+1;
        str_elements=str_folder+"Mesh/Slope/NN/p_refinement/";
...
switch Order
 ...
 %       EltOpts.Sort_nXi=1:NumberOfGaussPoints(9);
end
