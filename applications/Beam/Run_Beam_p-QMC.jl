...
folder = string(pathToInterm,"/Interm2/Beam") # for report
...
@everywhere MatlabSampler() = eval_string(string("Solver_L_JULIA_MATLAB_READ_IN_p_QMC(", myid(), ")"))
init_Beam_MC_L_Het_Single_high=Coupling_Beam.init_Beam(SL(),true,false,false,false,true,true,nb_of_warm_up_samples=2,nshifts=10,max_level=3,startlevel=3,MatlabSampler,folder,folder_with_elements,false,nterms=nterms,NQoI=1,numberoftol=30,ptgen=pt)
