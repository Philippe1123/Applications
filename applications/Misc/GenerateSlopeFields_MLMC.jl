...
folder_with_elements="/home/philippe/Desktop/RunFiles/debug/MLMC_3/h_refinement"
...
PathNodes=string(string(folder_with_elements,string("/","Nodes_L_0")),".txt")
...
println(expfield(Zf))
Zf=expfield(Zf)
Zf_res=open("/home/philippe/Desktop/RunFiles/debug/C3","w")
